...
Flowers <- Flowers[Flowers$OffID==0,]

# 3. Combine columns with base R function paste()
Flowers <- data.frame(Flowers[,1:5],loc1 = paste(Flowers[,6:7], sep=":"), 
                                    loc2 = paste(Flowers[,8:9], sep=":"), 
                                    loc3 = paste(Flowers[,10:11], sep=":"), 
                                    loc4 = paste(Flowers[,12:13], sep=":"), 
                                    loc5 = paste(Flowers[,14:15], sep=":"),  
                                    loc6 = paste(Flowers[,16:17], sep=":"),  
                                    loc7 = paste(Flowers[,18:19], sep=":"))
