...
```{r}
g.Flowers <- read_population(system.file("extdata", "pulsatilla_genotypes.csv",package = "LandGenCourse"),type = "column",locus.columns = c(6:19), phased=F,sep=",",header = TRUE)

g.Flowers <- filter(g.Flowers, OffID==0)
