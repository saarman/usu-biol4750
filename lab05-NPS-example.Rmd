...
```{r}
# Create a data frame of xy coordinates from Flr
df <- Flr[, c("X", "Y")]

# Convert the data frame into a matrix of xy coordinates
xy_matrix <- as.matrix(df)
...
# Example comparison with nancycats
data(nancycats)
class(nancycats@other)  # Should also return "list"
